...
public class AdaptadorLugares extends
    ...
    public void personalizaVista(ViewHolder holder, Lugar lugar) {
        ...
        int id = R.mipmap.otros;
        switch(lugar.getTipo()) {
            case RESTAURANTE:id = R.mipmap.restaurante; break;
            case BAR:        id = R.mipmap.bar;         break;
            case COPAS:      id = R.mipmap.copas;       break;
            case ESPECTACULO:id = R.mipmap.espectaculos; break;
            case HOTEL:      id = R.mipmap.hotel;       break;
            case COMPRAS:    id = R.mipmap.compras;     break;
            case EDUCACION:  id = R.mipmap.educacion;   break;
            case DEPORTE:    id = R.mipmap.deporte;     break;
            case NATURALEZA: id = R.mipmap.naturaleza;  break;
            case GASOLINERA: id = R.mipmap.gasolinera;  break;
        }
